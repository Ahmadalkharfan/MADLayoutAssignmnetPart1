...
class _MyStatefulWidgetState extends State<MyStatefulWidget> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('My Home'), centerTitle: false),
      body: (GridView.count(
        primary: false,
              ...
              children: <Widget>[
                Text('Lights',
                    style: TextStyle(
                        ...
                        color: Colors.black)),
                Icon(
                  _islightOn == true ? Icons.settings_power_sharp : Icons.light,
                  size: 50,
                ),
                RaisedButton(
                  onPressed: () {
              ...
              children: <Widget>[
                Text('AC',
                    style: TextStyle(
                        ...
                        color: Colors.black)),
                Icon(
                  _isacOn == true ? Icons.settings_power_sharp : Icons.ac_unit,
                  size: 50,
                ),
                RaisedButton(
                  onPressed: () {
